...
from utils.collections2 import AttrDict
import six
import yaml
import torch
...
__C.SMALL.FEATURE_MAPS_SMALL = [[38, 38], [19, 19], [10, 10], [5, 5], [3, 3], [1, 1]]
__C.SMALL.FEATURE_MAPS_LARGE = [[38, 38], [19, 19], [10, 10], [5, 5], [3, 3], [1, 1]]
...
__C.SMALL.STEPS_SMALL = [[8, 8], [16, 16], [32, 32], [64, 64], [100, 100],
                   [300, 300]]

__C.SMALL.STEPS_LARGE = [[8, 8], [16, 16], [32, 32], [64, 64], [100, 100],
                   [300, 300]]



__C.SMALL.MIN_SIZES = [30, 60, 111, 162, 213, 264]
__C.SMALL.MIN_SIZES_SMALL = [30, 60, 111, 162, 213, 264]
__C.SMALL.MIN_SIZES_LARGE = [30, 60, 111, 162, 213, 264]

__C.SMALL.MAX_SIZES = [60, 111, 162, 213, 264, 315]
__C.SMALL.MAX_SIZES_SMALL = [60, 111, 162, 213, 264, 315]
__C.SMALL.MAX_SIZES_LARGE = [60, 111, 162, 213, 264, 315]

__C.SMALL.ASPECT_RATIOS = [[2, 0.5], [2, 3, 0.5, 0.333], [2, 3, 0.5, 0.333],
                           [2, 3, 0.5, 0.333], [2, 0.5], [2, 0.5]]
__C.SMALL.ASPECT_RATIOS_SMALL = [[2, 0.5], [2, 3, 0.5, 0.333], [2, 3, 0.5, 0.333],
                           [2, 3, 0.5, 0.333], [2, 0.5], [2, 0.5]]
__C.SMALL.ASPECT_RATIOS_LARGE = [[2, 0.5], [2, 3, 0.5, 0.333], [2, 3, 0.5, 0.333],
                           [2, 3, 0.5, 0.333], [2, 0.5], [2, 0.5]]
...
UAVROOT = '/raid/jing/data/dataset/UAVdevkit2017/'
DOTAROOT = '/raid/jing/data/dataset/DOTAdevkit2019/'
IIAI_SATROOT = '/raid/flx/data/jing_detection/data/IIAI_SATdevkit2019/'
Objects365_TinyROOT = '/raid/jing/data/dataset/Objects365/'
...
__C.DATASETS.SETS.UAV = [['2017', '2017_trainval']]
__C.DATASETS.SETS.UAVval = [['2017', 'test']]
__C.DATASETS.SETS.DOTA = [['2019', 'train']]
__C.DATASETS.SETS.IIAI_SAT = [['2019', 'train']]
__C.DATASETS.SETS.IIAI_SATval = [['2019', 'val']]
__C.DATASETS.SETS.DOTAval = [['2019', 'val']]
__C.DATASETS.SETS.Objects365_Tiny = [['train']]
__C.DATASETS.SETS.Objects365_Tinyval = [['val']]
__C.DATASETS.SETS.VOCROOT = VOCROOT
__C.DATASETS.SETS.COCOROOT = COCOROOT
__C.DATASETS.SETS.UAVROOT = UAVROOT
__C.DATASETS.SETS.DOTAROOT = DOTAROOT
__C.DATASETS.SETS.IIAI_SATROOT = IIAI_SATROOT
__C.DATASETS.SETS.Objects365_TinyROOT = Objects365_TinyROOT
...
Objects365_Tiny_CLASSES = ('__background__', 'pomelo', 'pig', 'race car', 'rice cooker', 'tuba', 'crosswalk sign', 'papaya',
                           ...
                           'binoculars', 'llama', 'radish', 'noodles', 'mop', 'yak', 'crab', 'microscope', 'barbell', 'bread/bun',
                           'baozi', 'lion', 'red cabbage', 'polar bear', 'lighter', 'mangosteen', 'seal', 'comb', 'eraser', 'pitaya',
                           'scallop', 'pencil case', 'saw', 'table tennis paddle', 'okra', 'starfish', 'eagle', 'monkey', 'durian',
                           'rabbit', 'game board', 'french horn', 'ambulance', 'hoverboard', 'asparagus', 'pasta', 'target',
